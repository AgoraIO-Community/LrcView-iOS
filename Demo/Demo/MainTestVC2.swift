...
extension MainTestVC2: PanelViewDelegate, RTCManagerDelegate, ProgressTimerDelegate {
...
extension MainTestVC2: ParamSetVCDelegate, SearchVCDelegate, KaraokeDelegate {
