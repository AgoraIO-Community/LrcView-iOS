...
//        view.addSubview(lineScoreView)
        ...
        karaokeView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
...
extension MiniSizeVC: AgoraRtcEngineDelegate {
...
extension MiniSizeVC: AgoraRtcMediaPlayerDelegate {
